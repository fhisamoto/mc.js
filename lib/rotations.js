...
var lorentz_rotation = function(p_ref, k) {	
...
var inverse_lorentz_rotation = function(p_ref, k) {
  var cos_theta = p_ref.cos_theta(), sin_theta = p_ref.sin_theta(), 
			cos_phi = p_ref.cos_phi(), sin_phi = p_ref.sin_phi();
...
exports.lorentz_rotation = lorentz_rotation;
exports.inverse_lorentz_rotation = inverse_lorentz_rotation;